...
#ifndef PREDICTION_UTIL_LIB_CORE_THREADPOOL_H_
#define PREDICTION_UTIL_LIB_CORE_THREADPOOL_H_
...
class ThreadPool {
 ...
 private:
  ...
  COMMON_DISALLOW_COPY_AND_ASSIGN(ThreadPool);
};

}  // namespace thread
}  // namespace prediction

#endif  // PREDICTION_UTIL_LIB_CORE_THREADPOOL_H_
